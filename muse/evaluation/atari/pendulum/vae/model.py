from muse.evaluation.atari.pendulum.vae.model_components import *
...
class MUSE(nn.Module):
    ...
    def gen_latents(self, image=None, sound=None):
        with torch.no_grad():
    ...
    def gen_image(self, image=None, sound=None):
        with torch.no_grad():
